...
\begin{flushleft}
  \begin{tabular}{ c l l }
    ...
    2 & Altium tutorial 2 (components) & Schematic submission for review  \\
    3 & Schematic review  &                \\
    4 & Altium tutorial 3 (PCB) &          \\
    5 & PCB layout  & Early PCB submission \\
    6 & PCB layout  & PCB submission     \\
    10 & General    & Blinky            \\    
...
The blinky test falls in the mid-semester break but is one of the
major steps to finishing this assignment. It requires having a
...
microcontrollers flash memory. \emph{Do not underestimate how tricky
  this can be}.
